...
{% api-method method="post" host="{{ base\_url }}" path=" /organizations/team/list/{level}/{sid}/{serializer}/" %}
{% api-method-summary %}
Team List
{% endapi-method-summary %}
...
{% api-method method="get" host="{{ base\_url }}" path=" /organizations/team/detail/{sid}/" %}
{% api-method-summary %}
Team Detail
{% endapi-method-summary %}
...
{% api-method method="patch" host="{{ base\_url }}" path=" /organizations/team/detail/{sid}/" %}
{% api-method-summary %}
Team Detail
{% endapi-method-summary %}
...
{% api-method method="delete" host="{{ base\_url }}" path=" /organizations/team/detail/{sid}/" %}
{% api-method-summary %}
Team Detail
{% endapi-method-summary %}
